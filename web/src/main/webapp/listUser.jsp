...
<form method="post" action="EmployeeFindAllServlet" id="listform">
      <ul class="search" style="padding-left:10px;">
        <li>
		  用户名:
          <input type="text" placeholder="请输入搜索关键字" name="ename" value="${requestScope.ename}" class="input" style="width:250px; line-height:17px;display:inline-block" />
		  手机号:
          <input type="text" placeholder="请输入搜索关键字" name="phone" value="${requestScope.phone}" class="input" style="width:250px; line-height:17px;display:inline-block" />
    ...
    <table class="table table-hover text-center">
      ...
      <c:forEach items="${requestScope.list}" var="emp">
        <tr>
          ...
          <td>
            <div class="button-group"> <a class="button border-main" href="EmployeeFindOneServlet?eid=${emp.eid}">
            <span class="icon-edit"></span> 修改</a>
            <a class="button border-red" href="javascript:void(0)" onclick="del(${emp.eid})">
